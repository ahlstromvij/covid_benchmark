...
Table \ref{tab:tab1} provides details on the distribution of participants across the three conditions along measured variables. Table \ref{tab:tab2} gives details on the achieved proportion and sample targets by gender and ethnicity.
...
knitr::kable(summary_df,
             caption="Demographic and other pre-treatment variables by treatment",
             booktabs=TRUE,
             linesep = "",
             escape = FALSE, 
             label="tab1",
